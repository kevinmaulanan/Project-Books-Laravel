<body class="align">
    ...
    <div class="grid">
      ...
      <form action="{{url('auth/login')}}" method="POST" class="form login">
        @csrf
        <h1 class="h4 text-gray-900 mb-4" style="text-align: center;">Login Page</h1>
      ...
      <p class="text--center">Not a member? <a href="{{url('auth/register')}}">Sign up now</a> <svg class="icon">
