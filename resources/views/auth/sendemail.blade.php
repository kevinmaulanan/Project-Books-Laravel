...
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" yahoo="fix"
  style="font-family: 'Open Sans', Arial, sans-serif;" align="center" id="body">
  <custom type="content" name="ampscript">
    ...
    <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
      <tr>
        <td align="center" bgcolor="#f3f3f5" valign="top" width="100%">
          ...
          <table align="center" border="0" cellpadding="0" cellspacing="0" class="mobileView" width="600">
            <tr>
              <td align="center" bgcolor="#FFFFFF" style="padding:0px;" width="100%">

                <!--================================SECTION 0==========================-->
                <table align="center" bgcolor="" border="0" cellpadding="0" cellspacing="0" class="fullScreen"
                  style="width:100% !important;background-color:#625a9c;" width="600">
                  <tr>
                        ...
                        <tr>
                          <td valign="top" align="left" width="100%" style="padding-left: 25px;">
                            <img style="max-width: 150px; height: auto"
                              src="https://s3.amazonaws.com/growth.lyft.com/Business/Logos/Business_LogoPink%402x.png"
                              alt="Lyft for Business" />
                          </td>
                        </tr>
                      </table>
                      <table cellspacing="0" cellpadding="0" align="center" border="0" width="100%" bgcolor="#F3F3F5">
                ...
                <table align="center" bgcolor="" border="0" cellpadding="0" cellspacing="0" class="fullScreen"
                  style="width:100% !important;" width="600">
                  <tr>
                    <td bgcolor="" class="" style="width:100% !important; padding: 0;">
                      <custom type="content" name="hero_image">
                        ...
                        <table cellspacing="0" cellpadding="0" align="left" border="0" width="100%" bgcolor="#ffffff">
                          <tr>
                            <td valign="top" align="center" width="100%"
                              ...
                              <img width="100%" style="max-width: 600px; height: auto"
                                src="https://s3.amazonaws.com/growth.lyft.com/Business/Images/Hero%20Images/Verifyemail_hero%402x.png"
                                alt="Lyft business profile" />
                            </td>
                          </tr>
                        </table>
                        <!--END HERO IMAGE-->
                        ...
                        <table width="100%" align="center" cellpadding="0" cellspacing="0" border="0"
                          ...
                          <tr>
                            <td
                              style="font-family: 'LyftPro-Bold', Arial, Helvetica, sans-serif; font-size: 14px; line-height: 1.0; color: #000000; font-weight: bolder; text-transform: uppercase; padding: 25px 25px 5px 25px;"
                              class="mso-line-solid">
                              YOU'RE ONE STEP AWAY
                            </td>
                          </tr>
                          <tr>
                            <td
                              style="font-family: 'LyftPro-Bold', Arial, Helvetica, sans-serif; font-size: 52px; line-height: 1.0; color: #000000; font-weight: bolder; padding: 0 25px 15px 25px;"
                              class="mso-line-solid mobile-headline">
                              Verify your email address
                            </td>
                          </tr>
                          <tr>
                            <td
                              style="font-family: 'LyftPro-Regular', Arial, Helvetica, sans-serif; font-size: 18px; line-height: 1.4; color: #000000; padding: 0 25px 50px 25px;">
                              To complete your profile and start taking business rides with Lyft, you'll need to verify
                              your email address.
                            </td>
                          </tr>
                        ...
                        <table cellspacing="0" cellpadding="0" align="center" border="0" width="80%" bgcolor="#ffffff">
                          <tr>
                            <td valign="top" align="center" width="100%">
                              ...
                              <table width="100%" align="center" cellpadding="0" cellspacing="0" border="0"
                                bgcolor="#EFEFF1" style="max-width: 600px; background-color: #EFEFF1;">
                                <tr>
                                  <td align="center" style="padding: 0px;">
                                    <table align="center" cellpadding="0" cellspacing="0" border="0" bgcolor="#EFEFF1">
                                      <tr>
                                        <td align="center" valign="top"
                                          style="padding: 25px 25px 25px 25px; background-color: #EFEFF1;">
                                          <img
                                            src="https://s3.amazonaws.com/growth.lyft.com/Business/Icons/Module%203_email_icon%402x.png"
                                            width="50" border="0"
                                            style="display: inline-block; width: 50px; height: auto; outline: none;">
                                        </td>
                                        <td align="left"
                                          style="font-family: 'LyftPro-Regular', Arial, Helvetica, sans-serif; font-size: 18px; line-height: 1.4; color: #000000; padding: 15px 15px 15px 0; background-color: #EFEFF1;">
                                          Have a question? <br />
                                          <a href="/cdn-cgi/l/email-protection#d4b6a1a7bdbab1a7a7f9a7a1a4a4bba6a094b8adb2a0fab7bbb9"
                                            style="color: #ff00bf;">Reach out to our team</a>
                                        </td>
                                      </tr>
                                    </table>
                                  </td>
                ...
                <table align="center" bgcolor="#ffffff" border="0" cellpadding="0" cellspacing="0" class="mobileView"
                  style="width:100% !important;" width="600">
                  <tr>
                    <td>
                      <table align="center" bgcolor="#ffffff" border="0" cellpadding="0" cellspacing="0"
                        class="mobileView" width="100%">
                        <tr>
                          <td align="left"
                            style="color: #88888f; font-family: 'LyftPro-Regular', 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 12px; line-height: 18px; font-weight:normal; padding: 10px 0px 0px 25px;"
                            valign="middle" width="100%">
                            <a class="footerLinks" href="https://help.lyft.com/hc/en-us"
                              style=" text-decoration: none; color: #88888f" target="_blank"><span
                                class="contact">Contact</span></a>
                          </td>
                        </tr>
                        <tr>
                          <td align="left"
                            style="color: #88888f; font-family: 'LyftPro-Regular', 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 12px; line-height:18px; font-weight: normal; padding: 10px 0px 0px 25px; text-decoration: none;"
                            valign="middle">
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="hideDevice">
      <tr>
        <td class="hideDevice" height="1" style="min-width:700px; font-size:0px; line-height:0px;"><img height="1"
            src="http://image.lyftmail.com/lib/fe6915707166047a7d14/m/8/Spacer+for+Gmail.gif"
            style="min-width: 700px; text-decoration: none; border: none; -ms-interpolation-mode: bicubic;"></td>
      </tr>
    </table>
    ...
    <table border="0" cellpadding="0" cellspacing="0" align="center">
      <tr>
        <td border="0" align="center" height="1" style="font-size:0px; line-height:0px;">
          <img src="https://pixel.inbox.exacttarget.com/pixel.gif?r=4a4f30aa41389e0aba9e92c56574b86e3fc20465" width="1"
            height="1" />
          <img src="https://pixel.app.returnpath.net/pixel.gif?r=4a4f30aa41389e0aba9e92c56574b86e3fc20465" width="1"
            height="1" />
        </td>
      </tr>
    </table>
